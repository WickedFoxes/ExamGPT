...
class CustomExam(Exam):
    def __init__(self, content, imgcontent):
        super().__init__(imgcontent)
        self.gpt.add_vision_message("user", "text", self.readPrompt("gpt/prompt/CustomExam.prompt"))
        self.gpt.add_vision_message("user", "text", "<<input.txt>>\n\n"+content)